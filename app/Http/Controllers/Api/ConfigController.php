...
class ConfigController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($request->identity_card_image) {
            ...
            $request->identity_card_image->move("images/ktps/", $imageName);
            $user->identity_card_image = $request->root() . '/images/ktps' . '/' . $imageName;
        }
        if ($request->identity_card_image_salve) {
            ...
            $request->identity_card_image_salve->move("images/ktps/user/", $imageName);
            $user->identity_card_image_salve = $request->root() . '/images/ktps/user/' . $imageName;
        }
        $user->save();
