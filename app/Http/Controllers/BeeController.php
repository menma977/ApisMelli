...
class BeeController extends Controller
{
    ...
    public function QRCode($id)
    {
        ...
        $QR = QrCode::format('png')->size(500)->merge('../public/dist/img/AdminLTELogo.png', 0.3, true)->errorCorrection('H')->generate($bee->qr);
    ...
    public function QRCodeList(Request $request)
    {
        ...
        $bee->map(function ($item) {
            $item->BarCode = QrCode::format('png')->size(250)->merge('../public/dist/img/AdminLTELogo.png', 0.3, true)->errorCorrection('H')->generate($item->qr);
        });
